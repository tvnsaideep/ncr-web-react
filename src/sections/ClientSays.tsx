function ClientSays() {
    return (
        <>
        <section className="w-100 clearfix clientsSay" id="clientsSay">
   <div className="container">
      <div className="clientsSayInner">
         <div className="commonHeading headingCenter">
            <h4>Clients <span>Say</span></h4>
            <p className="mb-0">In addition to a wide variety of products, customers can utilize a plethora of
               in-house services.</p>
         </div>

         <div className="owl-carousel owl-theme clientsSaySlider">
            <div className="item">
               <div className="clientsSaySlideItem">
                  <div className="clientsSaySlideRow">
                     ...
                     <div className="clientsSaySlideCol">
                        <div className="clientsSaySlideContent">
                           ...
                           <div className="clientsSayGroup">
                              <div className="clientsSayNam">
                                 <h5>Marguerite Joe</h5>
                                 <span>Customer</span>
                              </div>
                              <div className="clientsSayReview">
