...
function SpecialDish () {
    ...
    return (
        <>
           <section className="w-100 clearfix specialDishTiffin" id="specialDishTiffin">
            ...
            <div className="specialDishTiffinInner">
               <div className="specialDishTiffinRow">
                  <div className="specialDishTiffinCol">
                     ...
                     <h1><span>Experience</span> bold <span>Chettinad</span> Flavors </h1>
                     <p>Serving delicious Chettinad, North Indian, and Desi-Chinese cuisines, 
                     choose from vegetarian and non-vegetarian meal options.</p>
                  ...
                  <div className="specialDishTiffinCol">
                     <div className="specialTiffinBannerImg">
                        ...
                        <div className="sTiffinBox splTiffinRating movingjs" data-value="6" style={{height:'15%'}}>
                           <div className="specialTiffinLeft">
                              <div className="specialTiffinImg">
                              </div>
                              <div className="specialTiffinTxt" style={{paddingLeft:"15%"}}>
                                 <p className="mb-0">Chicken Chettinad <br></br> Special Gravy</p>
                                 <span>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="arrowLine" width="131" height="134"
                           ...
                           <path
                              ...
                              stroke="#5E0821" strokeWidth="2" strokeDasharray="8 8" />
                           <path d="M107.683 21.3457L111.105 13.5811L118.87 17.0033" stroke="#FFA31E" strokeWidth="1.5"
                              strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
